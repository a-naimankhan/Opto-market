...
<<<<<<< HEAD:Server/optomarket_back/api/serializers.py
...
=======
    def validate(self, attrs):
        ...
        if discount_price is not None and price is not None and discount_price >= price:
            raise serializers.ValidationError({'discount_price': 'Новая цена должна быть меньше обычной цены'})

        return attrs
>>>>>>> origin/feat/fixing-bugs:optomarket_back/api/serializers.py
